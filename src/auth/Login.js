      ...
      <div className=' w-11/12 max-w-[700px] px-10 py-20 rounded-3xl bg-white border-2 border-gray-100'>
            ...
            <div className='mt-8'>
                <div className='flex flex-col'>
                    <label className='text-lg font-medium text-zinc-900'>Email</label>
                    <input 
                        value={email}
                        onChange={(e) => setEmail(e.target.value)}
                        className='w-full border-2 border-gray-100 rounded-xl p-4 mt-1 bg-transparent text-zinc-900'
                        placeholder="Enter your email"/>
                </div>
                <div className='flex flex-col mt-4'>
                    <label className='text-lg font-medium text-zinc-900'>Password</label>
                    <input 
                        value={password}
                ...
                <div className='mt-8 flex justify-between items-center'>
                    <div>
                        ...
                        <label className='ml-2 font-medium text-base text-zinc-900' for="remember">Remember for 30 days</label>
                    </div>
